...
<div class="col-12 col-md-10 col-lg-8 mx-auto sec-indexpost">
    <h1 class="text-4 text-center my-4 text-secondary">Actualiza tu información</h1>
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6 d-flex align-items-center justify-content-center mt-3 mt-md-0">
            <div class="card" style="width: 250px; height: 250px; border: none;">
    ...
    <div class="d-flex justify-content-center mt-3 mb-5">
        <button type="submit" form="form-create" style="padding: 0.6rem 5rem;" class="btn btn-primary" id="submit-create">Actualizar</button>
    </div>
</div>
