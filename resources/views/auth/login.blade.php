...
<body>
    <div class="container-fluid" style="height: 100vh;">
        <div class="row h-100 d-flex align-items-center">
            <div class="col-md-6 p-5 h-100 d-flex align-items-center">
                <div class="p-5">
            ...
            <div class="col-md-6 p-5 h-100 d-flex align-items-center justify-content-center" style="background-color: #F7F7F7;">
